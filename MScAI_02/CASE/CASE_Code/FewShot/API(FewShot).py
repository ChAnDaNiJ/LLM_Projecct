...
MAX_RETRIES = 5
OUTPUT_FILE = "FewShot_CASE_labeled.csv"
...
EMG_coru: 6.06256
EMG_trap: 10.21794
Valence_class, Arousal_class: 2,2
...
EMG_coru: 6.0544
EMG_trap: 13.93706
Valence_class, Arousal_class: 1,2
...
EMG_coru: 6.85126
EMG_trap: 11.2857
Valence_class, Arousal_class: 2,1
...
def build_multi_row_prompt(rows: pd.DataFrame):
    ...
    return header + instructions + examples + body.strip()
...
async def main():
    ...
    print("✅ Few-shot labels generated successfully!")
